...
public partial class EnglistCenterContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA41411992AFF9");
        ...
        {
            entity.HasKey(e => e.ClassId).HasName("PK__class__FDF47986998ABC3F");
            ...
            entity.HasMany(d => d.SchoolDays).WithMany(p => p.Classes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ClassId", "SchoolDayId").HasName("PK__class_da__4B5092A9295AD947");
                        j.ToTable("class_day");
        ...
        {
            entity.HasKey(e => e.CourseId).HasName("PK__course__8F1EF7AE31352FA0");

            entity.ToTable("course");

            entity.HasIndex(e => e.CourseCode, "UQ__course__AB6B45F171CC586E").IsUnique();
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__role__760965CCE005FAB7");
        ...
        {
            entity.HasKey(e => e.SchoolDayId).HasName("PK__school_d__6A4EB2FA1E1C847D");
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__student__2A33069A1589292A");
        ...
        {
            entity.HasKey(e => new { e.StudentId, e.ClassId }).HasName("PK__student___55EC4102AA3002AA");
        ...
        {
            entity.HasKey(e => e.TeacherId).HasName("PK__teacher__03AE777EA53B827D");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370F04C5BDAA");

            entity.ToTable("user");

            entity.HasIndex(e => e.Email, "UQ__user__AB6E6164AB5DD23F").IsUnique();
